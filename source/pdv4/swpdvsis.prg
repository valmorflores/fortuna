                 ...
                 IF lPrinter
                     ...
                     ELSE
                        ...
                        IF Impressora=="SIGTRON-FS345" .AND. !CarneInterno
                           ...
                           ImpFechaSem( cAcrDes, nPerAcrDes, nVlrAcrDes, nTotal, nValorPago, cMensagem + cCrediario, ALLTRIM( cCliCGCCPF ), nBanco )
...
Local xRetornar:= Nil
   ...
   ELSEIF xPar1 == _ABRIR
      ...
      IF !Used()
         ...
         IF !Used()
            Aviso( "O sistema PDV ja esta em uso neste computador." )
            Inkey(0)
            SetText()
            ffim()
            Quit
