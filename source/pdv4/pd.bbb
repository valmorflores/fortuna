...
#Define _VPB_VENDEDOR      &DiretorioDeDados\CDBANCOS.DBF
  ...
  SetColor( "00/07, 07/08" )
   ...
   IF (PortaScanner <> "NAO")
      IF File( DiretorioDeDados-"\PDVEAN__.DBF" )
          ...
          IF !File( DiretorioDeDados-"\EANIND01.NTX" ) .OR. !File( DiretorioDeDados-"\EANIND02.NTX" )
  ...
  ELSE
      SWGAviso( "ARQUIVO DE MATERIAS PRIMAS",;
              {{0, " "},;
               ...
               {0, " "},;
               {0, "   Inclua o arquivo CDMPRIMA.DBF no diretorio de dados do Fortuna"},;
               {0, " "},;
