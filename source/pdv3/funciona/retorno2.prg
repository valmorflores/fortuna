 ...
 nao esqueáa de carregar o driver residente ( MP20DRV.EXE )
...
while .t.
 ...
 @ 11,0 prompt "Datas                             "
 @ 12,0 prompt "Informaá‰es Variadas              "
 @ 13,0 prompt "Al°quota Tribut†ria               "
 @ 14,0 prompt "Recebimentos NÑo sujeitos ao ICMS "
...
//         vc_buffer := chr(27) + chr(251)+"40|#2|Conta da Xuxa      " + fim_protocolo_driver
    ...
    case vn_menu = 10
         ...
         string_devolvida := comunica_com_impressora(prepara_string,tamanho_de_retorno)
         @ 10,30      say "Data e Hora Ultima Reduá∆o ˛"
         @ 10,col()+1 say string_devolvida picture "@r 99/99/99 99:99:99"
         wait ""
         @ 10,00 say space(80)
         wait ""
...
static function outro_01_menu()
 ...
 while .t.
    ...
    vn_menu2 := 0
    @  2,0 prompt "N£mero de SÇrie                  "
    @  3,0 prompt "Vers∆o do Firmware               "
    @  4,0 prompt "CGC/IE                           "
    @  5,0 prompt "Grande Total                     "
    @  6,0 prompt "N£mero de Cancelamentos          "
    @  7,0 prompt "N£mero de Descontos              "
    @  8,0 prompt "Contador Sequàncial              "
    @  9,0 prompt "N£mero de Operaá‰es N∆o Fiscais  "
    @ 10,0 prompt "N£mero de Cupons Cancelados      "
    @ 11,0 prompt "N£mero de reduá‰es               "
    @ 12,0 prompt "N£mero de intervená‰es           "
    @ 13,0 prompt "N£mero de Substituiá‰es de Prop. "
    @ 14,0 prompt "N£mero do Ultimo Iten Vendido    "
    @ 15,0 prompt "Clichà do Propiet†rio            "
    menu to vn_menu2
...
static function outro_03_menu()
 ...
 while .t.
    ...
    vn_menu4 := 0
    @  2,0 prompt "Intervená∆o TÇcnica                   "
    @  3,0 prompt "Eprom Conectada                       "
    @  4,0 prompt "Truncamento                           "
    @  5,0 prompt "Vinculaá∆o ao ISS                     "
    menu to vn_menu4
...
static function outro_04_menu()
 ...
 while .t.
    ...
    @  9,0 prompt "Cancela Item GenÇrico                       "
...
//    @  8,0 prompt "Fecha Cupom Fiscal                          "
    ...
    do case
       ...
       case vn_menu5 = 9
            ...
            prepara_string := inicio_protocolo + "10|0000|00000000000000|A|Esta Ç a mensagem promocional...Hoje Ç sexta-feira..traga mais cerveja!!!!!!" + chr(10) +  fim_protocolo_driver
            comunica_com_impressora(prepara_string,tamanho_de_retorno)
...
static function outro_06_menu()
 ...
 while .t.
    ...
    @  3,0 prompt "Adiá∆o de Al°quota Tribut†ria               "
    menu to vn_menu7
