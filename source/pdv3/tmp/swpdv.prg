...
ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 Ultimo  Passo : APOS F1 RESTAURAR QUANT PARA 1
 Pr¢ximo Passo :
...
Function Browse(lFim, lCupomPendente, lVersaoConflito, cVersao)
  ...
  Local lComEAN := .T., nSalLimCre:= 0, lLimCredAvis := .F.
   ...
   Function fAuxilio (cVersao)
      ...
      SWGAviso( "AUXILIO                                                              3 de 3",;
              {{0, "   Confirmacao de Preco . . . . . . . . . . . . . . . . . . . . . . . . . . [F12]"},;
               {0, "   Auxilio  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . [CTRL+A]"},;
               {0, " "},;
               {0, "     Obs. : 1) As teclas [F12] e [CTRL+F12] sao identicas"},;
               {0, "            2) As teclas [F10] e [CTRL+F10] sao identicas"},;
               {0, "            3) As teclas [HOME] e [CTRL+A] sao identicas"},;
               {0, " "},;
               {1, "                           ( " + cVersao + " )"},;
               {0, " "}}, 7, 1, 300, 200, 800, 1220)
