...
Local aStr, nCodigo1:= 0, nCodigo2:= 999999, cCidade1:= Space( 30 ),;
   ...
   @ 02,02 Say "ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ"
...
IF !Used()
   ...
   IF !File( GDir-"\DIARIO.IGD" )
      Index On DATA__ To &GDir\DIARIO.IGD
   ENDIF
   Set index To &Gdir\DIARIO.IGD
ENDIF
DBGoBottom()
IF BOF()
   DBAppend()
...
Local cGrupo:= "401", cGrupoMateria:= "402"
   ...
   IF !MPR->( DBSeek( PAD( cGrupo + "0000", 12 ) ) )
      ...
      Replace MPR->CODIGO With cGrupo + "0000",;
              MPR->INDICE With cGrupo + "0000",;
              MPR->DESCRI With "ÄÄGRUPO RENNERÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ",;
              MPR->ORIGEM With "REN"
   ENDIF
