...
#Define _VPB_GRUPO         &DiretorioDeDados\GRUPOPRO.VPB
...
//       cBusca:= ""; lAchou := .T.
      ...
      DO CASE
         ...
         CASE nTecla==K_F2
              ...
              cCGCCPF:= PAD( IF( EMPTY( CLI->CPF___ ), CLI->CGCMF_, CLI->CPF___ ), 14 )
              cBusca:= ""; lAchou := .T.
         ...
         CASE nTecla == K_ENTER // #01
               ...
               IF nStatus==1 .OR. nStatus==2 .OR. nStatus==8 .OR. nStatus==9
                  ...
                  ELSEIF EMPTY( MPR->TABRED )
                     IF MPR->IPICOD == 4 .OR. MPR->IPICOD == 5       /* ISENTO */
                        cTabela:= STIsento
                     ELSEIF MPR->IPICOD == 1 .OR. MPR->IPICOD == 3 .OR.;
                            MPR->IPICOD == 6                         /* SUBSTITUICAO TRIBUTARIA */
         ...
         CASE nTecla==K_F8
              ...
              BoxFill( 415, 445, 050, 40, 20 + 32, 0 )
                            BoxFill( 720, 445, 248, 40, 20 + 32, 0 )
              BoxFill( 415, 387, 150, 40, 20 + 32, 0 )
              BoxFill( 415, 327, 315, 40, 20 + 32, 0 )
                            BoxFill( 800, 327, 315, 40, 20 + 32, 0 )
              ...
              @ 10, 15 Say "Cliente  " Get cCliDescri ;
                 ...
                 Valid BuscaCli( @nCliCodigo, @cCliDescri, @cCliEndere, ;
                    ...
                    @cCliCGCCPF, @cCliIEstadual, GetList )
              ...
              @ 18, 35 Say "Fone   " Get cCliFone PICT "@R XXXX-X999.9999";
              ...
              @ 22, 15 Say "CGC/CPF  " Get cCliCgcCpf ;
                 When Mensagem( "Digite o CFG/CPF do cliente" )
              @ 22, 45 Say "IE" Get cCliIEstadual
              SetCursor( 1 )
              READ
              SetCursor( 0 )
...
//               ExibeTotais( "Troco", nValorPago - nValorPagar )
                 ...
                 LancaCupom( nCliCodigo, cCliDescri, cCliEndere, cCliBairro, ;
                             cCliCidade, cCliEstado, cCliFone, nValorPagar, nVendedor, nForma )
...
ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
*/
Function BuscaCli( nCliCodigo, cCliDescri, cCliEndere,  cCliBairro,  cCliCidade,  cCliEstado, cCliFone, cCliCodCep,  cCliCGCCPF, cCliIEstadual, GetList )
Local cFontBrowse:= "VSYS14.PTX"
Local nCt:= 0
...
-------------------------------------*/
Function LancaCupom( nCliCodigo, cCliDescri, cCliEndere, cCliBairro, cCliCidade, cCliEstado, cCliFone, nValorPagar, nVendedor, nForma )
   ...
   CASE nCodigoArquivo==_COD_CLIENTE
       ...
       IF !Used()
          ...
          IF !File( DiretorioDeDados-"\CLIIND01.IGD" ) .OR. ;
             ...
             !File( DiretorioDeDados-"\CLIIND03.IGD" ) .OR. ;
             !File( DiretorioDeDados-"\CLIIND04.IGD" ) .OR. ;
             !File( DiretorioDeDados-"\CLIIND05.IGD" )
             ...
             Index On StrZero( FILIAL, 03, 00 ) +;
                     ...
                     Eval {|| .T. } to &DiretorioDeDados\CLIIND04.IGD
             Index On CODBAR Tag CLIX5 ;
                     Eval {|| .T. } ;
                     To &DiretorioDeDados\CLIIND05.IGD
          ENDIF
