...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
       ...
       IF cRelEst=="E" 
          ...
          @ 11,07 Say Repl( "�", nPerc ) Color cCor1 + "/" + CorFundoAtual() 
          nPerc:= ( nValorNota / nValorTotal ) * 70 
          @ 12,07 Say Repl( "�", nPerc ) Color cCor2 + "/" + CorFundoAtual() 
 
          nPerc:= ( nQuantPedido / nQuantTotal ) * 70 
          @ 07,07 Say Repl( "�", nPerc ) Color cCor1 + "/" + CorFundoAtual() 
          nPerc:= ( nValorPedido / nValorTotal ) * 70 
          @ 08,07 Say Repl( "�", nPerc ) Color cCor2 + "/" + CorFundoAtual() 
 
          nPerc:= ( nQuantCotacao / nQuantTotal ) * 70 
          @ 03,07 Say Repl( "�", nPerc ) Color cCor1 + "/" + CorFundoAtual() 
          nPerc:= ( nValorCotacao / nValorTotal ) * 70 
          @ 04,07 Say Repl( "�", nPerc ) Color cCor2 + "/" + CorFundoAtual() 
