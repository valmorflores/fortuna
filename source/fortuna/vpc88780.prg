                      ...
                      IF PED->DATA__ >= dData1_ .AND. PED->DATA__ <= dData2_ 
                         ...
                         WHILE !EOF() 
                             IF CODPED==StrZero( nCodPed, 8, 0 ) 
                                IF SWAlerta( "<< DUPLICIDADE DE INFORMACOES >>;Ja existe este pedido selecionado.; O que voce deseja fazer?", { "Incluir Novamente", "N�o incluir" } )==2 
                                   lIncluir:= .F. 
                                   DBGoTo( nReg ) 
                                   oTb:RefreshAll() 
                                   WHILE !oTb:Stabilize() 
                         ...
                         DBGoTo( nReg ) 
                      ELSE 
                         Aviso( "Pedido n�o foi gravado neste periodo." ) 
                         Pausa() 
                         lIncluir:= .F. 
                      ENDIF 
                   ELSE 
      ...
      do case 
         ...
         case nTecla==K_TAB .OR. nTecla==K_CTRL_F1 
              ...
              IF !LastKey()==K_ESC 
                 ...
                 @ 04,32 Say "1�" Get nCodTr1 Pict "@R 999" 
                 @ 05,32 Say "2�" Get nCodTr2 Pict "@R 999" 
                 @ 06,32 Say "3�" Get nCodTr3 Pict "@R 999" 
                 @ 07,32 Say "4�" Get nCodTr4 Pict "@R 999" 
                 @ 08,32 Say "5�" Get nCodTr5 Pict "@R 999" 
                 @ 09,32 Say "6�" Get nCodTr6 Pict "@R 999" 
                 @ 10,32 Say "7�" Get nCodTr7 Pict "@R 999" 
                 @ 11,32 Say "8�" Get nCodTr8 Pict "@R 999" 
                 @ 12,32 Say "9�" Get nCodTr9 Pict "@R 999" 
                 READ 
