...
//    cJaEmit  := "N" 
      ...
      WHILE( .T. ) 
         ...
         VPBox ( 04, 05, 21, 74, " GERA��O DE DUPLICATAS PARA REMESSA ", _COR_GET_EDICAO ) 
         Scroll( 06, 06, 20, 73 ) 
...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
           ...
           IF FILE( "VPCCTRLB.$$$" ) 
              ...
              ScreenRest( cVpcCtrlb ) 
*              Aviso( "Foram geradas " + Alltrim( Str( nReg, 6 ) ) + " duplicatas !" ) 
*              DiarioComunicacao( "��������������������///////COBRANCA BANCARIA///////���", "Fim da Selecao de Duplicatas" ) 
...
Local dDataVen1, dDataVen2, nConta1, nConta2,; 
     ...
     @ 04,02 Say "relacionadas n�o ser�o  selecionadas,  sendo  que  voce dever� ter  o m�ximo" Color "07/" + CorFundoAtual() 
     ...
     @ 08,01 Say Repl( "�", 78 ) Color "00/" + CorFundoAtual() 
   ...
   Function fArqRemet( cRemRet ) 
      ...
      ENDIF 
		...
		IF len(aFiles) > 0 
         ...
         /*���� Variaveis do objeto browse ���������������� Informacoes Diversas ����*/ 
			oTb:AutoLite:=.F. 
			...
			WHILE .T. 
               ...
               CASE nTecla==K_CTRL_TAB 
                    ...
                    IF cRemRet=="EXC" 
                       IF SWAlerta( "Deseja remarcar os registros; caso n�o estejam fazendo; parte da relacao de enviados", { "Confirma", "Cancela" } )==1 
                          aRegistros:= "" 
                          aRegistros:= {} 
                              ...
                              IF Left( aRegistros[ nCt ], 1 )=="E" 
                                 ...
                                 IF CTB->( DBSeek( SubStr( aRegistros[ nCt ], 2, 10 ), .T. ) ) 
                                    WHILE LEFT( CTB->IDECLI, 10 ) == SubStr( aRegistros[ nCt ], 2, 10 ) 
                                             ...
                                             IF CTB->( netrlock() ) 
                                                IF !Alltrim( CTB->SITUAC )=="<<EXCLUIR ITEM>>" 
                                                    ...
                                                    ELSE 
                                                       ...
                                                       Aviso( "Registro " + SubStr( CTB->IDECLI, 2, 10 ) + " n�o localizado..." ) 
                                                       Pausa() 
                                                       ScreenRest( cTelaR1 ) 
                                                    ENDIF 
                                                    ++nQuantReg 
                                          ...
                                          ELSE 
                                             cTelaR1:= ScreenSave( 0, 0, 24, 79 ) 
                                             Aviso( "Registro " + SubStr( aRegistros[ nCt ], 2, 10 ) + " n�o localizado..." ) 
                                             Pausa() 
                                             ScreenRest( cTelaR1 ) 
                                          ENDIF 
                                          CTB->( DBSkip() ) 
