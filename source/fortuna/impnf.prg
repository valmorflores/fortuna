...
@ Prow(),pcol() + 14 Say "�" 
@ Prow()+1,00 Say "� "+unzipchr(LINE01)+" � �"+repl("�",85)+"*" 
@ Prow()+1,00 Say "� "+unzipchr(LINE02)+" � ��Informacoes�" + Repl("�",72)          +"�" 
...
@ Prow()+1,00 Say "�"+repl("�",47)+      "� � Taxa financeira     "+tran(nTAXAF_,"@E 999,999,999,999.99")+spac(46)+"�" 
@ Prow()+1,00 Say "��FORNECEDOR�"+repl("�",35)+"� � Tipo de frete       "+if(nTFRETE=1,"<CIF> FOB","CIF <FOB>")+spac(55)+"�" 
@ Prow()+1,00 Say "� "+cDESFOR+" � � Reajuste            "+cREAJUS+spac(31)+"�" 
@ Prow()+1,00 Say "� "+cENDERE+spac(10)+" � �"+repl("�",85)+"�" 
...
@ Prow()+1,00 Say "�" + Repl( "�", 47 ) + "� �" + Repl( "�", 85 ) + "�" 
@ Prow()+1,00 Say Negrito(.T.) + "Solicitamos o fornecimento do material abaixo relacionado:" + Negrito( .F. ) 
@ Prow(),00   Say Condensado(.T.) 
@ Prow()+1,00 say "��Rg�*�Codigo�*�Descricao����������������������������"+; 
                  "*�Un�*�Quantidade�*�Valor�Unitario�*�Valor�Total�"+; 
                  "*ICM*�%IPI�*�Valor�IPI�*�Entrega�Ŀ" 
nCT:=0 
for nCT:=1 to 25 
...
next 
@ prow()+1,00 say "�����������������������������������������������������������������������������������������������������������������������������������������" 
@ prow()+1,00 say "�   ICMs   �"+spac(57)+"  � � Sub-Total    �"+tran(nSUBTOT,"@E 999999999.99")+" � ��Condicoes��������������������Ŀ" 
...
@ prow()+1,00 Say "������������������������������������������������������������������������ � IPI          �"+tran(nTOTIPI,"@E 999999999.99")+" � �                               �" 
@ prow()+1,00 Say "����OBS���������������������������������������������������������������Ŀ � Frete        �"+tran(nFRETE_,"@E 999999999.99")+" � � "+spac(7)+cCONDIC+spac(7)+" �" 
@ prow()+1,00 Say "�"+cOBSER1+"� �--------------�-------------� �                               �" 
@ prow()+1,00 Say "�"+cOBSER2+"� � Total        �"+tran(nTOTALG,"@E 999999999.99")+" � �                               �" 
@ prow()+1,00 Say "�"+cOBSER3+"� ������������������������������ �������������������������������Ĵ" 
