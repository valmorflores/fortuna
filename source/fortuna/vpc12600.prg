...
Local bInfo:= {|| .T. } 
   ...
   @ 02,02 Say "Cotacoes ������������������������������������������������������������������" Color "15/" + CorFundoAtual() 
   ...
   @ 06,02 Say "Movimentacoes Por Operador Em Treinamento ���������������������������������" Color "15/" + CorFundoAtual() 
   ...
   @ 10,02 Say "Movimentacoes Por Produto Que Estao em Desuso (Fora de linha)��������������" Color "15/" + CorFundoAtual() 
...
Local bPagarInfo:= {|| .T. }, bReceberInfo:= {|| .T. } 
   ...
   @ 02,02 Say "Contas a Pagar ������������������������������������������������������������" Color "15/" + CorFundoAtual() 
   ...
   @ 06,02 Say "Contas a Receber ����������������������������������������������������������" Color "15/" + CorFundoAtual() 
