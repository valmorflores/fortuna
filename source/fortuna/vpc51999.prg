...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
   ...
   WHILE LastKey() <> K_ESC 
      ...
      IF Len( aMatriz ) <> 0 
         ...
         @ 07, 02 Say "ÚO.CompÂUnÂQuantÄÄÄÄÂÄVALOR ÄÄÄÄÄÂÄREC ÄÄÄÄÄ¿" 
         ...
         FOR nCt:= 1 TO Len( aMatriz ) 
             ...
             ++nLinha 
             IF nLinha > 20 
                @ nLinha,02 Say "ÀÄÄÄÄÄÄÁÄÄÁÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÙ" 
                SetColor( "W+/R" ) 
...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
   ...
   WHILE LastKey() <> K_ESC 
      ...
      IF Len( aMatriz ) <> 0 
         nLinha:= 8 
         @ 07, 02 Say "ÚDataÄÄÄÄÂO.COMPÂFornecedorÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÂQuantidadÂValor Unit.¿" 
         FOR nCt:= 1 TO Len( aMatriz ) 
...
@ nLin+04, nCol + 2 Say "ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ ³                       ³" 
