...
whil .t. 
   Mensagem("") 
   AAdd(MENULIST,menunew(11,25," 1 Autom쟴ico          ",2,COR[11],; 
        "Lancamento autom쟴ico de notas fiscal.",,,COR[6],.T.)) 
