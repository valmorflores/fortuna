         ...
         do case
            ...
            case nTecla==K_SPACE
                 ...
                 IF MPR->( DBSeek( PAD( StrZero( aProdutos[ nRow ][ 1 ], 7, 0 ), 12 ) ) )
                    ...
                    // para empresas de Lucro Real sujeito ao regime n�o cumulativo
     ...
     do case
        ...
        Case nTecla==K_TAB
             ...
             IF !(nConfere==nTotal)
                ...
                Ajuda( "Total:" + Tran( nTotal, "@E 999,999,999.99" ) + " ����� Soma das Parcelas: " + Tran( nConfere, "@E 999,999,999.99" ) )
   ...
   if SWSet( _CMP_ATUALIZA_PRECO )
       ...
       if mpr->( dbseek( pad( cproduto, 12 ) ) )
           ...
           while !pxf->( eof() ) .and. pad( cproduto, 12 ) == pxf->cprod_
                ...
                pxf->( dbskip() )
           enddo
           // se n�o encontrou o fornecedor, cria o mesmo
           // com o preco == 0
           if !lok
              pxf->( dbappend() )
