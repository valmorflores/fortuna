...
Local nCliente:= 0, dDataIni:= CTOD( "01" + SubStr( DTOC( Date() ), 3 ) ),; 
   ...
   IF LastKey() <> K_ESC 
      ...
      IF nDevice == 1 
         AAdd( aMatriz, { "���", "QUITADAS  ", 0, 0, 0, 0, Space(8), nSoma1, Space(8), Space(8), nSoma4, 0 } ) 
         AAdd( aMatriz, { "���", "PENDENTES ", 0, 0, 0, 0, Space(8), nSoma2, Space(8), Space(8), 0, 0 } ) 
         AAdd( aMatriz, { "���", "TOTAL     ", 0, 0, 0, 0, Space(8), nSoma3, Space(8), Space(8), 0, 0 } ) 
...
Local nCliente:= 0, dDataIni:= CTOD( "01" + SubStr( DTOC( Date() ), 3 ) ),; 
   ...
   IF LastKey() <> K_ESC 
      ...
      IF nDevice == 1 
         AAdd( aMatriz, { "���", "QUITADAS  ", 0, 0, 0, 0, Space(8), nSoma1, Space(8), Space(8), nSoma4, 0, "TOTAL" + SPACE( 40 ) } ) 
         AAdd( aMatriz, { "���", "PENDENTES ", 0, 0, 0, 0, Space(8), nSoma2, Space(8), Space(8), 0, 0, "TOTAL" + SPACE( 40 ) } ) 
         AAdd( aMatriz, { "���", "TOTAL     ", 0, 0, 0, 0, Space(8), nSoma3, Space(8), Space(8), 0, 0, "TOTAL" + SPACE( 40 ) } ) 
         vpbox(0,0,22,79,"Bloquetos de Cobranca",COR[20],.T.,.T.,COR[19]) 
         @ 01,45 Say "Periodo de " + DTOC( dDataIni ) + " ate " + DTOC( dDataFim ) + "." 
         SetColor( "W+/BG" ) 
         @ 02,01 Say "Tipo Duplicata bco Agc Cta Gr Emissao  Vlr. Total  Vencimen Dt.Quit.  Juros    Conta " 
