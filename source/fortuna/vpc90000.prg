...
whil .t. 
   mensagem("") 
   aadd(MENULIST,swmenunew( 09,15," 1 Nota Fiscal      ",2,COR[11],; 
        "Inclusao, alteracao, verificacao e exclusao de notas fiscais.",,,; 
        COR[6],.T.)) 
   AAdd(MENULIST,swmenunew( 10,15," 2 Pedidos          ",2,COR[11],; 
        "Inclusao, alteracao, verificacao e exclusao de pedidos de clientes.",,,; 
        COR[6],.T.)) 
   aadd(MENULIST,swmenunew( 11,15," 3 Romaneio         ",2,COR[11],; 
        "Impress�o de Romaneio de Saida.",,,; 
        COR[6],.T.)) 
   aadd(MENULIST,swmenunew( 12,15," 4 Precos           ",2,COR[11],; 
        "Inclusao, alteracao, verificacao e exclusao de precos de venda.",,,; 
        COR[6],.T.)) 
   aadd(MENULIST,swmenunew( 13,15," 5 Estatistica      ",2,COR[11],; 
        "Dados estatisticos por cliente.",,,; 
        COR[6],.T.)) 
   aadd(MENULIST,swmenunew( 14,15," 6 Similaridade     ",2,COR[11],; 
        "Similaridade entre itens.",,,COR[6],.T.)) 
 
   aadd(MENULIST,swmenunew( 15,15," 7 Convenios        ",2,COR[11],; 
        "Informacoes sobre convenios/conveniados.",,,COR[6],.T.)) 
 
   aadd(MENULIST,swmenunew( 16,15," 8 Garantia         ",2,COR[11],; 
...
ELSE 
   ...
   whil .t. 
      ...
      mensagem("") 
      aadd(MENULIST,swmenunew( 11, 30, " 1 Assistente       ",2,COR[ 11 ],; 
           "Pedidos no Formato Telemarketing.",,,; 
           COR[6],.T.)) 
      AAdd(MENULIST,swmenunew( 12, 30, " 2 CPD              ",2,COR[ 11 ],; 
           "Inclusao de pedidos de clientes - Formato CPD.",,,; 
           COR[6],.T.)) 
      AAdd(MENULIST,swmenunew( 13, 30, " 3 Pendentes        ",2,COR[ 11 ],; 
           "Relacao de Pedidos Pendentes por Transportadora (ROTA).",,,COR[6],.T.)) 
      AAdd(MENULIST,swmenunew( 14, 30, " 4 Manual / Cotacao ",2,COR[ 11 ],; 
           "Inclusao / Alteracao de Cotacoes manualmente.",,,COR[ 6 ],.T.)) 
      @ 15, 30 Say "---------------------" Color COR[ 11 ] 
      AAdd(MENULIST,swmenunew( 16, 30, " 5 Selecao Multipla ",2,COR[ 11 ],; 
           "Seleciona Pedidos p/ Entrega.",,,COR[6],.T.)) 
      @ 17, 30 Say "---------------------" Color COR[ 11 ] 
      AAdd(MENULIST,swmenunew( 18, 30, " 6 Pesquisas        ",2,COR[ 11 ],; 
           "Pesquisas sobre pedidos.",,,COR[6],.T.)) 
      @ 19, 30 Say "---------------------" Color COR[ 11 ] 
      AAdd(MENULIST,swmenunew( 20, 30, " 0 Retorna          ",2,COR[ 11 ],; 
           "Retorna ao menu anterior.",,,COR[6],.T.)) 
      swMenu(MENULIST,@nOPCAO); MENULIST:={} 
      DO CASE 
...
Local nOpcao:= 1 
   ...
   whil .t. 
      ...
      mensagem("") 
      aadd(MENULIST,swmenunew( 18, 50, " 1 Selecionar       ",2,COR[ 11 ],; 
           "Fazer uma nova selecao",,,; 
           COR[6],.T.)) 
      AAdd(MENULIST,swmenunew( 19, 50, " 2 Ver Selecoes     ",2,COR[ 11 ],; 
           "Verificacao de Selecoes Realizadas.",,,; 
           COR[6],.T.)) 
      AAdd(MENULIST,swmenunew( 20, 50, " 0 Retorna          ",2,COR[ 11 ],; 
           "Retorna ao menu anterior.",,,COR[6],.T.)) 
      swMenu(MENULIST,@nOPCAO); MENULIST:={} 
      DO CASE 
...
Local nOpcao:= 1 
   ...
   whil .t. 
      ...
      mensagem("") 
      aadd(MENULIST,swmenunew( 16, 50, " 1 Aproveitamento   ",2,COR[ 11 ],; 
           "Verificar o aproveitamento de pedidos.",,,COR[6],.T.)) 
      AAdd(MENULIST,swmenunew( 17, 50, " 2 Lancamentos      ",2,COR[ 11 ],; 
           "Verificar pedidos lancados por periodo.",,,; 
           COR[6],.T.)) 
      AAdd(MENULIST,swmenunew( 18, 50, " 3 Lanc. Por Midia  ",2,COR[ 11 ],; 
           "Verificar Lancamentos por midia.",,,; 
           COR[6],.T.)) 
      AAdd(MENULIST,swmenunew( 19, 50, " 4 Controle Reserva ",2,COR[ 11 ],; 
           "Verificar Lancamentos por midia.",,,; 
           COR[6],.T.)) 
      AAdd(MENULIST,swmenunew( 20, 50, " 0 Retorna          ",2,COR[ 11 ],; 
           "Retorna ao menu anterior.",,,COR[6],.T.)) 
