...
Local aMoedas:= {}, dDataOrigem:= DATE(), nValor:= PrecoConvertido(),; 
   ...
   whil .t. 
      ...
      IF lDisplay 
          DispBegin() 
          Mensagem( "[Seta Esquerda]Origem [Seta Direita]Destino [îïğñ]Move [Enter]Valor [üışÿ]Sair" ) 
          VPBox( nLin1, nCol1, nLin1 + 15, nCol1 + 50, " CONVERSAO DE MOEDAS ", _COR_ALERTA_BOX ) 
          SetColor( _COR_ALERTA_BOX ) 
          @ nLin1 + 1, nCol1 + 1 Say " Origem     ³       VARIACOES       ³ Destino    " 
          @ nLin1 + 2, nCol1 + 1 Say "ÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄ" 
          @ nLin1 + 3, nCol1 + 1 Say "            ³     <<<ÄÄÄÄÄÄÄ>>>     ³            " 
          @ nLin1 + 4, nCol1 + 1 Say "ÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄ" 
          @ nLin1 + 5, nCol1 + 1 Say "            ³                       ³            " 
          @ nLin1 + 6, nCol1 + 1 Say "            ³                       ³            " 
          @ nLin1 + 7, nCol1 + 1 Say "            ³                       ³            " 
          @ nLin1 + 8, nCol1 + 1 Say "ÄÄÄÄÄÄÄÄÄÄÄÄ´                       ÃÄÄÄÄÄÄÄÄÄÄÄÄ" 
          @ nLin1 + 9, nCol1 + 1 Say "            ³                       ³            " 
          @ nLin1 +10, nCol1 + 1 Say "ÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄ" 
