...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
  ...
  AADD( mOP, { 99, "������ FORTUNA ������" } ) 
  AADD( mOP, { 1,  "��Cadastros          " } ) 
  AADD( mOP, { 11, "� ��Clientes         " } ) 
  AADD( mOP, { 12, "� ��Fornecedores     " } ) 
  AADD( mOP, { 13, "� ��Produtos         " } ) 
  AADD( mOP, { 14, "� ��Bancos           " } ) 
  AADD( mOP, { 141,"� � ��Banrisul       " } ) 
  AADD( mOP, { 15, "� ��Vendedores       " } ) 
  AADD( mOP, { 2,  "��Estoque            " } ) 
  AADD( mOP, { 3,  "��Compras (O.C.)     " } ) 
  AADD( mOP, { 4,  "��Venda              " } ) 
  AADD( mOP, { 41, "� ��Pedido           " } ) 
  AADD( mOP, { 42, "� ��Nota Fiscal      " } ) 
  AADD( mOP, { 5,  "��Financeiro         " } ) 
  AADD( mOP, { 51, "� ��Comissoes        " } ) 
  AADD( mOP, { 52, "� ��Bloquetos        " } ) 
  AADD( mOP, { 6,  "��Relatorios         " } ) 
  AADD( mOP, { 61, "� ��Clientes         " } ) 
  AADD( mOP, { 62, "� ��Produtos         " } ) 
  AADD( mOP, { 63, "� ��Estoque          " } ) 
  AADD( mOP, { 64, "� ��Contas a Pagar   " } ) 
  AADD( mOP, { 65, "� ��Contas a Receber " } ) 
  AADD( mOP, { 0,  "��Geral              " } ) 
  AADD( mOP, { 100,"��Meu Computador     " } ) 
  AADD( mOP, { 110,"  ��Mouse            " } ) 
  AADD( mOP, { 120,"  ��Protecao de tela " } ) 
  AADD( mOP, { 121,"  � ��Padrao         " } ) 
  AADD( mOP, { 122,"  � ��Navegador      " } ) 
  AADD( mOP, { 130,"  ��Barra de Rolagem " } ) 
  AADD( mOP, { 140,"  ��Monitor          " } ) 
  AADD( mOP, { 160,"  ��Atualizacao      " } ) 
  AADD( mOP, { 150,"  ��Portas Impressao " } ) 
...
stat func modulo( nMod ) 
  ...
  do case 
     ...
     case nMod=160 
          @ 03,25 Say "Comando de Captura de Versao ������������������������" 
          @ 04,25 Say LEFT( Alltrim( SWSet( _SYS_COMANDOVERSAO ) ), 53 ) Color "14/" + CorFundoAtual() 
          @ 05,25 Say "Atualizacao de Executavel ������� REPORT\VERSAO.INI �" 
...
Local nLinha:= 0, aConfig, nCt, cArqOrigem, cArqDestino 
   ...
   IF Len( aNewConfig ) > 0 
      ...
      IF Confirma( 0, 0, "Confirma a gravacao dos par�metros do sistema?",; 
