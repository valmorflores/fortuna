...
VPBOX( 03, 27, 14, 75,,_COR_GET_BOX ) 
VPBOX( 15, 27, 17, 75,,_COR_GET_BOX ) 
...
WHILE ! EOF() 
    ...
    IF Len( aDados ) = 0 
       ...
       VPObsBox(.T.,10,30, "Atencao",; 
              {"Informa��es na Base de dados",; 
               "s�o insuficientes para gerar",; 
