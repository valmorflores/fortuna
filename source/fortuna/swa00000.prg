...
MenBarraRolagem:= " �� Soft&Ware Inform�tica �� �������� �� (51)471.6249 9134.6249 9112.8364 �� ������������������" 
...
SetBlink(.F.) 
ScreenBack:= " ���� Fortuna ���������į��� Disco de Atualizacao do Sistema ���� " 
vptela() 
...
Function AtualExecuta( lAutomatico, nTipoMaquina ) 
   ...
   IF nTipoMaquina == 1 
      ...
      /* 
         ...
         arquivo CONFIG.INI pois o mesmo n�o � necessario nesta pasta 
      */ 
...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
      ...
      ELSE 
         ...
         /* Copia da instalcao caso n�o exista o arquivo GRUPODBF.DBF */ 
   ...
   IF ( nTipoMaquina )==2 
      ...
      /* Exclui arquivos *.UPD, desnecessarios a computadores que n�o s�o 
...
Function EditaParametro( aArray, nRow, oTb ) 
  ...
  IF aArray[ nRow ][ 2 ]==Repl( "�", 60 ) 
     Aviso( "Este parametro n�o deve ser alterado nesta janela." ) 
     Pausa() 
     ScreenRest( cTela ) 
     SetColor( cCor ) 
     Return Nil 
