...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
   ...
   @ 04,02 Say "ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´" 
   @ 05,02 Say "³ Produto: [000]-[0000]  ³                                                 ³" 
   @ 06,02 Say "ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ" 
   ...
   WHILE LastKey() <> K_ESC 
      ...
      IF Len( aMatriz ) <> 0 
         DO CASE 
            CASE nOpcao == 1 
                 nLinha:= 8 
                 @ 07, 02 Say "ÚDataÄÄÄÄÂN.FiscÂClienteÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÂQuantidadÂValorÄÄÄÄÄÄ¿" 
                 FOR nCt:= 1 TO Len( aMatriz ) 
                    ...
                    ++nLinha 
                    IF nLinha > 20 
                       @ nLinha,02 Say "ÀÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÁÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÙ" 
                       cCorRes:= SetColor() 
                       SetColor( "15/05" ) 
...
DO CASE 
   ...
   @ 02,02 Say "ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿" 
   @ 03,02 Say "³ Cliente: [000000]      ³                                                 ³" 
   @ 04,02 Say "ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´" 
   @ 05,02 Say "³ Produto: [000]-[0000]  ³                                                 ³" 
   @ 06,02 Say "ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ" 
   ...
   WHILE LastKey() <> K_ESC 
      ...
      IF Len( aMatriz ) <> 0 
         DO CASE 
            CASE nOpcao == 1 
                nLinha:= 8 
                @ 07, 02 Say "ÚN.FiscÂUnÂQuantidadeÄÂValorÄÄÄÄÄÄÄÄÄÄÂDataÄÄÄÄ¿ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿" 
                FOR nCt:= 1 TO Len( aMatriz ) 
                    ...
                    ++nLinha 
                    IF nLinha > 20 
                       @ nLinha,02 Say "ÀÄÄÄÄÄÄÁÄÄÁÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÙ" 
                       SetColor( "W+/R" ) 
                       @ nLinha,55 Say " [Enter]Continuar... " 
                       SetColor( cCorRes ) 
                       Mensagem( "Digite o nome do produto ou pressione [ENTER] para ver proxima tela..." ) 
                    ...
                    @ 09,51 Say "ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ" 
                    @ 11,51 Say "ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ" 
                    @ 13,51 Say "ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ" 
                    @ 15,51 Say "ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ" 
                    @ 17,51 Say "ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ" 
                    @ 19,51 Say "ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ" 
                    SetColor( cCorRes ) 
                    @ nLinha, 02 Say "ÀÄÄÄÄÄÄÁÄÄÁÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÙ" 
                NEXT 
            CASE nOpcao == 2 
...
WHILE .T. 
      ...
      @ nLin+02, nCol + 2 Say "ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿ Ú Ordem ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿" 
      @ nLin+03, nCol + 2 Say "³        Periodo de Emissao      ³ ³ 1-Numero Nota Fiscal  ³" 
      @ nLin+04, nCol + 2 Say "ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ ³ 2-Nome do Cliente     ³" 
      @ nLin+05, nCol + 2 Say "³ De: [DD/MM/AA] At‚: [DD/MM/AA] ³ ³ 3-Data de Emissao     ³" 
      @ nLin+06, nCol + 2 Say "ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ" 
      @ nLin+07, nCol + 2 Say "ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿ Ú Saida ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿" 
      @ nLin+08, nCol + 2 Say "³      Periodo dentro do Mes     ³ ³                       ³" 
      @ nLin+09, nCol + 2 Say "ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ ³  Monitor  Impressora  ³" 
      @ nLin+10, nCol + 2 Say "³       Do Dia: [01] a [31]      ³ ³                       ³" 
      @ nLin+11, nCol + 2 Say "ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ" 
...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
      ...
      @ nLin+07, nCol + 2 Say "ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿ Ú Saida ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿" 
      @ nLin+08, nCol + 2 Say "³     Periodo dentro do mes      ³ ³                       ³" 
      @ nLin+09, nCol + 2 Say "ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ ³        MONITOR        ³" 
...
//                     AAdd( aGrafico, { cMesAnoAnt, nSomaMes, 0 } ) 
            ...
            /* RESUMO DE OPERACOES */ 
            @ 16,01 Say "ÄÄÄ RESUMO ÄÄ" + Repl( "Ä", 65 ) 
...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
      ...
      @ nLin+05, nCol + 2 Say "³ De: [DD/MM/AA] At‚: [DD/MM/AA] ³ ³ 3-Data de Emissao     ³"
      @ nLin+06, nCol + 2 Say "ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ"
      @ nLin+07, nCol + 2 Say "ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿ ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿"
      @ nLin+08, nCol + 2 Say "³     Periodo dentro do mes      ³ ³ Preco de Custo        ³"
      @ nLin+09, nCol + 2 Say "ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´"
...
@ nLin+02, nCol + 2 Say "ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿ Ú Tipo das Notas ÄÄÄÄÄÄÄ¿" 
@ nLin+03, nCol + 2 Say "³        Periodo de Emissao      ³ ³ (V)enda               ³" 
@ nLin+04, nCol + 2 Say "ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ ³ (O)utras              ³" 
@ nLin+05, nCol + 2 Say "³ De: [DD/MM/AA] At‚: [DD/MM/AA] ³ ³ (T)odas     [ ]       ³" 
@ nLin+06, nCol + 2 Say "ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ" 
@ nLin+07, nCol + 2 Say "ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿ Ú Tipo do Relatorio ÄÄÄÄ¿" 
@ nLin+08, nCol + 2 Say "³       Codigo do Cliente        ³ ³                       ³" 
@ nLin+09, nCol + 2 Say "ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ ³ (D)etalhado           ³" 
...
@ nLin+04, nCol + 2 Say "ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ ³     Nome do Cliente   ³" 
...
WHILE LastKey() <> K_ESC 
      ...
      ENDDO 
      IF nDevice == 1 
         AAdd( aMatriz, { 0, "ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ", "ÄÄÄÄÄÄÄÄÄ", 0, 0, 0, 0 } ) 
...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
      ...
      @ nLin+02, nCol + 2 Say "ÚÄ Utilizacao ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿" 
      ...
      @ nLin+06, nCol + 2 Say "ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ" 
      @ nLin+07, nCol + 2 Say "ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿ Ú Saida ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿" 
...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
      ...
      WHILE !EOF() .AND. nCt < 10 
         ...
         @ nLin, 28 Say Repl( "Û", nPosicoes * nMulti ) 
         SetColor( "N/" + cCorFundo ) 
         @ nLin+1, 29 Say Repl( "ß", nPosicoes * nMulti ) 
         @ nLin, 28 + nPosicoes * nMulti Say "Ü" 
         DBSkip() 
...
@ nLin+02, nCol + 2 Say "ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿ ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿"
@ nLin+03, nCol + 2 Say "³        Periodo de Emissao      ³ ³ Agrupado por: [ ]     ³"
@ nLin+04, nCol + 2 Say "ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´"
