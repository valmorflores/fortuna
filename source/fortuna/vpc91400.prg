      ...
      WHILE .t. 
         ...
         DO CASE 
            ...
            CASE nTecla==K_TAB 
                 ...
                 SetColor( _COR_GET_EDICAO ) 
                 SetCursor(1) 
                 @ 16,40 Say    "ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ" 
...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
    ...
    @ 05,57 Say "AtÇ:" Get dDataFim 
    @ 06,32 Say "Mes Calculo.:" Get dDataI2 
    @ 06,57 Say "AtÇ:" Get dDataF2 
    @ 07,32 Say "Data Calculo:" Get dDataBase 
    @ 08,32 Say "ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ" 
    READ 
    ...
    FOR nCt:= 10 TO 10 
        ...
        @ 20,32 Say SubStr( Repl( "∞∞±±±≤≤≤€€€€±±±±±", 20 ), nCt * 3, 42 ) COLOR StrZero( nCt, 2, 0 ) + "/01" 
           ...
           IF !( NF_->VENIN_ + NF_->VENEX_ ) == 0 
              FOR nVnd:= 1 TO 2 
                 ...
                 IF DBSeek( nCodVendedor ) .AND. nCodVendedor > 0 
                    FOR nCt:= 1 to 10 
                       DBSelectAr( _COD_VENDEDOR ) 
                       /* Leitura e gravacao das comissoes da 1ß/10ß Formula */ 
                       IF nCt == 1 
                          nFormula:=  VEN->FORM01 
                          nMesIni:=   VEN->MINI01 
                          nMesFim:=   VEN->MFIM01 
