...
//* APONTADOR DA OPCAO *// 
@ nLIN1+nCURSOR,nCOL1 say if(cAPONTA1<>NIL,cAPONTA1,"�") Color cCorApontador 
@ nLIN1+nCURSOR,nCOL2 say if(cAPONTA2<>NIL,cAPONTA2,"�") Color cCorApontador 
   ...
   do case 
      ...
      case nTECLA==K_PGDN                      //* PAGE DOWN *// 
           if nPOSICAO+nTLIN<=nTAM_ 
              ...
              @ nLIN1+nCURSOR,nCOL1 say " " Color cCorApontador 
              @ nLIN1+nCURSOR,nCOL2 say " " Color cCorApontador 
              @ nLIN1,nCOL1 say if(cAPONTA1<>NIL,cAPONTA1,"�") Color cCorApontador 
              @ nLIN1,nCOL2 say if(cAPONTA2<>NIL,cAPONTA2,"�") Color cCorApontador 
              nPOSICAO:=nTAM_ 
              nCURSOR:=0 
           endif 
           setcolor(cCOR) 
