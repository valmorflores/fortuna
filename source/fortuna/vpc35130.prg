...
// ## CL2HB-ERRO - Talvez estas linhas ainda necessitem de correcoes, verifique
   ...
   oTAB:addcolumn(tbcolumnnew(,{|| CODIGO + " " + IIF( TIPO__=="1", DESCRI + "����>" + Tran( VALOR_, "@E 999,999.99" ), IF( TIPO__=="2", "  * Cupom *" + StrZero( CUPOM_, 8, 0 ) + " " + DTOC( DATA__ ), "     " + PRODUT + Tran( VALOR_, "@E 999,999.999" ) ) )+ SPACE( 60 ) })) 
   oTAB:AUTOLITE:=.f. 
   oTAB:dehilite() 
   WHILE .t. 
